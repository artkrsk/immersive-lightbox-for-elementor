...
/**
 * Player builders: a native `<video>` for self-hosted files, a privacy-first
 * controllable iframe for embeds. `autoplay` only ever true for the
 * actually-opened slide — never for preloaded neighbors (the AGC lesson).
 */
