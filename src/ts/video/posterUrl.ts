 ...
 *
 * Vimeo has no id-derivable URL: it needs an oEmbed round trip, so it lives in
 * `vimeoPoster` next door — asynchronous, cached, and asked for by the one
 * consumer that can wait for it.
 */
