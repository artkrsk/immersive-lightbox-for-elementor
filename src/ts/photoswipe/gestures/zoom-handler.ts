...
import { clamp, equalizePoints, getDistanceBetween, pointsEqual } from '../util/util'
...
class ZoomHandler {
  ...
  change(): void {
    ...
    let currZoomLevel =
      (1 / getDistanceBetween(startP1, startP2)) * getDistanceBetween(p1, p2) * this._startZoomLevel
  ...
  private _calculatePanForZoomLevel(axis: 'x' | 'y', currZoomLevel: number): number {
