...
Elementor's native lightbox returns exactly as it was, and so does WooCommerce's product gallery lightbox. The plugin claims clicks in the browser and never rewrites your content.
